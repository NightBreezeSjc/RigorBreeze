...
Before approval, perform a semantic self-review for placeholders, contradictions, oversized scope, and ambiguous outcome, source-of-truth, freshness, or fallback meaning; resolve project facts directly and ask only about outcome-changing ambiguity.
